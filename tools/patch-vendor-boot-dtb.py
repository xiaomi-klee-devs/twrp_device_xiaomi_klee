#!/usr/bin/env python3
"""Build a chagall vendor-boot DTB without Android USB offload coupling.

Reads the stock MTK-wrapped DTB (prebuilt/dtb/mt6899-chagall.dtb), removes the
...
def patch_dtb(input_path: pathlib.Path, output_path: pathlib.Path) -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="chagall-dtb-") as temporary_directory:
